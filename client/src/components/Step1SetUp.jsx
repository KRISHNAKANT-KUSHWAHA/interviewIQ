...
function Step1SetUp({ onStart }) {
  ...
  // fetch API of generate question
  ...
  return (
    <motion.div
      ...
      from-gray-100 to-gray-200 px-4"
    >
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hiddens">
        {/* left area */}
        <motion.div
          initial={{ x: -80, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
          transition={{ duration: 0.7 }}
          className="relative bg-gradient-to-br from-blue-60 to-green-100 p-12 flex-col justify-center"
        >
          ...
          <div className="space-y-5">
            {[
              ...
              <motion.div
                ...
                transition={{ delay: 0.9 + index * 0.35 }}
              ...
              >
                ...
                {resumeFile && (
                  <motion.button
                    ...
                    className="mt-4 bg-gray-700 text-white px-5 py-2 rounded-lg hover:bg-gray-800 transition"
                  >
