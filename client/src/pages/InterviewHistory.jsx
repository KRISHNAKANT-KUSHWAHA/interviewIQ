...
function InterviewHistory() {
  ...
  const navigate = useNavigate(); // click and sent to interview-report page

  //fetch api for all interview
  useEffect(() => {
    const getMyInterviews = async () => {
      try {
        ...
        // console.log(result.data);  //print all interviews in console
      } catch (error) {
        console.log(error);
      }
    };
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 to-emerald-100 py-10">
      <div className="w-[90vw] lg:w-[70vw] max-w-[90%] mx-auto">
        {/* top */}
        <div className="mb-10 w-full flex items-start gap-6 flex-wrap">
          <button
            onClick={() => navigate("/")}
