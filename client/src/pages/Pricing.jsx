...
function Pricing() {
  ...
  const dispatch = useDispatch(); // update th user
  ...
  const handlePayment = async (plan) => {
    try {
      ...
      const amount = plan.id === "basic" ? 10 : plan.id === "pro" ? 50 : 0;
      ...
      const options = {
        ...
        handler: async function (response) {
          ...
          dispatch(setUserData(verifypay.data.user)); //update the user
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-emerald-50 py-16 px-6">
      {/* top */}
